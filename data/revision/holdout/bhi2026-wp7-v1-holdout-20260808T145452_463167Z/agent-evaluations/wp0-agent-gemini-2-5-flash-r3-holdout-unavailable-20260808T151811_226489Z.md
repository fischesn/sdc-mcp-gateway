...
- Run ID: `wp0-agent-gemini-2-5-flash-r3-holdout-unavailable-20260808T151811_226489Z`
- Agent: `llm-gemini`
- Status: `ok`
- Passed tasks: 5/5
- Resource count: 4
...
| `provider_availability` | `availability_detection` | True | No device state is currently available. The device list is empty. |
