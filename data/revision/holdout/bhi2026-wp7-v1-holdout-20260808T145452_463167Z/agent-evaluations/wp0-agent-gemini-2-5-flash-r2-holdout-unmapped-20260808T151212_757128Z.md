...
- Run ID: `wp0-agent-gemini-2-5-flash-r2-holdout-unmapped-20260808T151212_757128Z`
- Agent: `llm-gemini`
- Status: `ok`
- Passed tasks: 5/5
- Resource count: 8
...
| `metrics_resource_selection` | `resource_selection` | True | The URI for the metrics resource of the specified device was selected based on matching the device ID, device type, and resource kind. |
